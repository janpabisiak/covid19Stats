...
?>
            ...
            <div class="bg">
                ...
                <div class="container text-center">
                    ...
                    <div class="buttons flex-row">
                        <a class="btn btn-purple btn-lg" href="#stats">
                            Global Stats
        ...
        <div class="content">
            <main role="main">
                        ...
                        <div class="row pb-5">
                            <div class="col-md-12">
                                <div class="blog-list-box">
                                    <div class="blog-list-category list-last">
                                        <ul class="blog-list">
                                            <li class="blog"><a href="symptoms" style="color:#eee">Symptoms COVID-19</a></li>
                                            <li class="blog"><a href="prevention" style="color:#eee">Prevention</a></li>
                                            <li class="blog"><a href="disinformation" style="color:#eee">Disinformation</a></li>
                                            <li class="blog"><a href="https://www.msn.com/en-us/news/coronavirus" style="color:#eee">The latest information on COVID-19</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                ...
                <section id="stats">
                    <div class="container">
                        <h2 class="text-center mb-3 pt-2">World Stats</h2>
                    ...
                    <div class="container">
                        <h2 class="text-center mb-3 pt-2">World Stats - only Today</h2>
                        <center><p>Last updated: <?php echo date('m/d/Y H:i:s', $seconds); ?></p></center>
                        <div class="row pb-5">
                            <div class="col-md-6">
                                <div class="stats-box">
                            ...
                            <div class="col-md-6">
                                <div class="stats-box">
                                    <div class="stats-body">
                                        <?php echo number_format($population); ?>
                                    </div>
                                    <div class="stats-footer">
                    ...
                    <div class="container">
                        <h2 class="text-center mb-3 pt-2">World - Numbers as a percentage</h2>
                        <center><p>Last updated: <?php echo date('m/d/Y H:i:s', $seconds); ?></p></center>
                        <div class="row pb-5">
                            <div class="col-md-6">
                                <div class="stats-box">
